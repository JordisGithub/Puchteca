			...
			<div className="homeContainer">
				...
				<div className="pLocationsContainer">
					<div className="pLocationsLeftRight">
						<div className="pLocationsLeft">
							...
							<a href="/" className="codeAThonText">Annual Code-A-Thon Location</a>
							<a href="/" className="viewPButton">
								VIEW PROGRAMS
							</a>
						</div>
						<div className="pLocationsRight">
							<div className="mapColumn">
								<img src={MapImage} alt="png"></img>
							</div>
						</div>
					</div>
				</div>
				<div className="volunteersContainer">
					...
					<div className="vCardsLeftRight">
						<a href="/" className="forStudents"><img src={ForStudents}  alt="png"></img></a>
						<a href="/" className="forEveryone"><img src={ForEveryone}  alt="png"></img></a>
					</div>
